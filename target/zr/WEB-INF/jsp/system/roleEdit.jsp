...
<script type="text/javascript">
	function save() {
		$('#roleAddForm').form('submit', {
			url : '${pageContext.request.contextPath}/system/role/edit.action',
			success : function(d) {
				d = $.parseJSON(d);
				if (d.success) {
					parent.closeEdit();
...
<body style="text-align: center;">
	<form id="roleAddForm" method="post">
		...
		<table style="width: 100%;">
			<tr>
				<td>角色名称</td>
				<td><input id="name" name="name" value="${role.name}" class="easyui-textbox" style="width: 300px" data-options="required:true"></td>
			</tr>
			<tr>
				<td>角色备注</td>
				<td>
					<textarea id="mark" name="mark"  style="width: 300px;border-radius: 5px;border: 1px solid #FF6633;">${role.mark}</textarea>
				</td>
			</tr>
			<tr>
				<td>拥有权限</td>
