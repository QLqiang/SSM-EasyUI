...
<script type="text/javascript">
	...
	function imp(){
		$('#impDiv').panel('open');
		$("#impIframe").attr("src","${pageContext.request.contextPath}/system/user/userImp.action");
	}
</script>
</head>
<body class="easyui-layout">
	...
	<div id="impDiv" class="easyui-dialog" title="批量导入" style="width: 540px; height: 100px;" data-options="iconCls:'icon-filter',resizable:true,modal:true,closed:true">
		<iframe id="impIframe" style='width:100%;height:98%;border:0px;overflow: hidden;' src=''></iframe>
	</div>
</body>
</html>
